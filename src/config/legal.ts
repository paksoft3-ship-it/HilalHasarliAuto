...
export const privacyDoc: LegalDoc = {
  ...
  sections: [
    ...
    { id: "reklam-koruma", heading: "Reklam Trafiği ve Tıklama Koruması", blocks: [{ type: "p", text: "Reklam bütçemizi geçersiz/otomatik (bot) tıklamalara karşı korumak amacıyla, reklam bağlantılarımız üzerinden gelen ziyaretlerde IP adresi, tarayıcı bilgisi (user-agent), cihaz/teknik bilgiler ve sayfa etkileşim sinyalleri işlenir. Bu veriler yalnızca dolandırıcılık tespiti ve reklam ölçümü için kullanılır, pazarlama amacıyla üçüncü taraflara satılmaz ve en fazla 90 gün saklanıp ardından otomatik olarak silinir." }] },
