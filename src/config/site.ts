...
export const siteConfig = {
  ...
  phoneDisplay: env("NEXT_PUBLIC_PHONE_DISPLAY", "0552 567 71 64"),
  phoneE164: env("NEXT_PUBLIC_PHONE_E164", "+905525677164"),
  whatsappE164: env("NEXT_PUBLIC_WHATSAPP_E164", "+905525677164"),
