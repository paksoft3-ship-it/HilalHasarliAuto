...
export const siteConfig = {
  ...
  phoneDisplay: env("NEXT_PUBLIC_PHONE_DISPLAY", "0541 911 90 40"),
  phoneE164: env("NEXT_PUBLIC_PHONE_E164", "+905419119040"),
  whatsappE164: env("NEXT_PUBLIC_WHATSAPP_E164", "+905419119040"),
